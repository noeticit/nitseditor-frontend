<template>
    <dashboard-layout-one active="form">
        <base-bread-crumb-one name="Edit Form" :breadcrumbs="breadcrumbs"></base-bread-crumb-one>
                    ...
                    <div class="">
                        <div class="grid grid-cols-5 gap-4 mb-8">
                            <div class="col-span-4">
                                <input class="w-full focus:outline-none border border-gray-700 h-8 px-8 rounded" v-model="form_title" placeholder="Edit Title" type="text" >
                            </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            fetchData() {
                this.$api.get('/nits-system-api/form/'+this.$route.params.edit,
                ).then(response => {
                    if (response.status === 200)
                    {
