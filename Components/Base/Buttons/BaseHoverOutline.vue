<template>
    <button class="flex rounded-full border-transparent px-4 py-2 focus:outline-none text-black hover:border-blue-600 hover:text-blue-600 justify-around" tabindex="0">
        ...
        <span class="ml-2 font-serif">Hover Outline</span>
    </button>
</template>
