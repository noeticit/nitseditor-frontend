<template>
    <div class="bg-teal-100 absolute right-0 mr-3  border-t-4 w-22.333333% border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
        <div class="flex">
            <div class="py-1">
