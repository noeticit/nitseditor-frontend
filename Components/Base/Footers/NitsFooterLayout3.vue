    ...
    <div class="">
        ...
        <div class=" flex h-32 w-screen mx-auto justify-between bg-gray-200">
            <div class="float-left mt-10 ml-56 ">
                <h1 class="text-3xl ">FOOTER - LAYOUT 3</h1>
            </div>
          ...
          <div class="flex ml-56  mt-20">
            <div class="flex flex-col">
                ...
                <div class="flex flex-row mt-8">
                    ...
                    <div class="flex flex-col mt-6 ml-10">
             ...
             <div class="flex flex-col ml-12">
                    ...
                    <div class="flex bg-gray-800 h-10 w-64 mt-5 rounded">
                        ...
                        <input type="name" class="bg-gray-700 px-8 text-gray-300 text-left rounded-r" placeholder="Full Name">
                    </div>
                    <div class="flex bg-gray-800 h-10 w-64 mt-3 rounded">
                        ...
                        <input type="email" class="bg-gray-700 px-8 text-gray-300 text-left rounded-r" placeholder="Enter your Email">
                    </div>
                    <textarea class="  bg-gray-700 mt-3 px-4 py-6 mr-10 text-left text-gray-300 rounded" placeholder="Message"></textarea>
...
<script>
    export default {
        name: "NitsFooterLayout3",
        data() {
            return {
                breadcrumbs: ['Home', 'Templates', 'Footer 3'],
            }
        },
