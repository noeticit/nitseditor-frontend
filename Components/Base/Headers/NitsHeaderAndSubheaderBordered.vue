<template>
    <div class="bg-white shadow-lg">
        <nav class="md:container mx-auto flex items-center justify-between flex-wrap px-4 lg:px-0 h-18">
            ...
            <div class=" flex items-center flex-shrink-0 px-6  py-5  lg:border-r-2">
                <a class="">
            ...
            <div class="w-full h-full block lg:flex lg:items-center lg:w-auto hidden">
                ...
                <div class="hover:text-teal-400  lg:border-l-2 lg:w-20 flex flex-row">
                    <div class="border-l-4 lg:border-l-0  block mt-4 lg:inline-block lg:mt-0 mx-6 lg:h-25 lg:py-10 px-2">
                        <svg class="w-6 h-6 ml-" version="1.1" id="User" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                             viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve">
                            <path fill="#000000" d="M7.725,2.146c-1.016,0.756-1.289,1.953-1.239,2.59C6.55,5.515,6.708,6.529,6.708,6.529
                ...
                <div class="hover:text-teal-400  lg:border-l-2 lg:w-20 flex flex-row">
                    <div class="border-l-4 lg:border-l-0  block mt-4 lg:inline-block lg:mt-0 mx-6 lg:h-25 lg:py-10 px-2">
                        <svg class="w-6 h-6" version="1.1" id="Shopping_cart" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                             y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve">
                ...
                <div class="hover:text-teal-400 lg:border-l-2 lg:w-20 flex flex-row">
                    <div class="border-l-4 lg:border-l-0  block mt-4 lg:inline-block lg:mt-0 mx-6 lg:h-25 lg:py-10 px-2">
                        <svg class="w-6 h-6" version="1.1" id="Magnifying_glass" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
                             y="0px" viewBox="0 0 20 20" enable-background="new 0 0 20 20" xml:space="preserve">
...
<script>
    export default {
        name: "NitsHeaderAndSubheaderBordered",
        data(){
            return{
