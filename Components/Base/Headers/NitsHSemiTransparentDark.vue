<template>
    <div class="relative">
        ...
        <nav class="fixed top-0 py-6 px-8 mx-auto bg-black w-screen opacity-75 ">
            <div class="flex justify-between">
                ...
                <div class="mr-24 text-lg font-semibold">
                    <div class="float-right">
                        <div class="inline-block cursor-pointer text-white p-1 mx-3" @mouseover="isVisible = true" @mouseleave="isVisible = false" @keydown.enter="isVisible = !isVisible">
                            <div class="inline-flex items-center justify-between px-2 py-1 font-medium  transition-all duration-500 rounded-md focus:outline-none focus:text-brand-900 sm:focus:shadow-outline">
                                <span class="flex-shrink-0 tracking-widest cursor-defaul text-sm">{{label1}}</span>
                            </div>
                        ...
                        <div class="mr-6 p-1 inline-block" @mouseover="Visible = true" @mouseleave="Visible = false" @keydown.enter="Visible = !Visible">
                            <div class="inline-flex items-center justify-between px-2 py-1 font-medium  transition-all duration-500 rounded-md focus:outline-none focus:text-brand-900 sm:focus:shadow-outline">
                                <span class="flex-shrink-0 tracking-widest text-white text-sm">{{label2}}</span>
                            </div>
                            <transition enter-active-class="transition duration-300 ease-out transform" enter-class="-translate-y-3 scale-95 opacity-0" enter-to-class="translate-y-0 scale-100 opacity-100" leave-active-class="transition duration-150 ease-in transform" leave-class="translate-y-0 opacity-100" leave-to-class="-translate-y-3 opacity-0">
                        ...
                        <div class="inline-block cursor-pointer text-white p-1 mr-6">
                            <a class="flex-shrink-0 tracking-widest cursor-default text-sm" href="#">{{label3}}</a>
                        </div>
                        <div class="inline-block cursor-pointer text-white p-1 mr-6">
                            <a class="flex-shrink-0 tracking-widest cursor-default text-sm" href="#">{{label4}}</a>
                        </div>
                        <div class="inline-block cursor-pointer p-1 text-white mr-6">
                            <a class="flex-shrink-0 tracking-widest cursor-default text-sm" href="#">{{label5}}</a>
                        </div>
                        <div class="inline-block cursor-pointer p-2 text-white mx-3">
                            <a class="flex-shrink-0 tracking-widest cursor-default text-sm" href="#">{{label6}}</a>
                        </div>
                        <div class="inline-block cursor-pointer p-2 text-white mr-6">
                            <a class="flex-shrink-0 tracking-widest cursor-default text-sm" href="#">{{label7}}</a>
                        </div>
                        <div class="inline-block cursor-pointer pt-2 text-white mr-6">
            ...
            <div class="pl-32 pr-10 ml-48" v-if="box">
                <input class="w-full h-8 ml-2 border border-white mt-4 py-1 px-10 bg-transparent rounded placeholder-white text-sm focus:outline-none antialiased tracking-wide font-medium text-white leading-norma" type="text" placeholder="Search">
            </div>
        </nav>
