        ...
        <div class=" bg-black  w-full">
            <nav class=" container mx-auto flex items-center justify-between flex-wrap px-4 lg:px-0 h-10 w-full">
                <div class=" flex items-center flex-shrink-0 ">
                    <span class="text-white ml-6">All Cities</span>
<!--                    <div>All Cities</div>-->
                ...
                <div class="w-full h-full block lg:flex lg:items-center lg:w-auto hidden">
                    <ul class="lg:flex-grow font-small  flex flex-col lg:flex-row pb-4 lg:pb-0 text-white text-sm">
                        <li class="  hover:text-gray-400">
                            <div href="" class="flex border-l-4 lg:border-l-0 block mt-4 lg:inline-block lg:mt-0 mx-4 lg:h-25 lg:py-10 px-2">
                                <div class="w-4">
