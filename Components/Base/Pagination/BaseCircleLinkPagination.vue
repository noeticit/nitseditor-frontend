...
<!--                </p>-->
      ...
      <span class="relative inline-flex ">
        <ul class="flex">
            <li class=" mr-1">
            <a class="rounded-full mt-1 py-1 px-2 inline-block bg-blue-100 text-blue-600 bg-transparent hover:bg-blue-600 hover:text-white focus:border-blue-300 ">
          ...
          <li class=" mr-1">
           ...
           <li class="mr-1">
            <a class="rounded-full mt-1 py-1 px-2 inline-block text-gray-700 hover:bg-blue-600 hover:text-white bg-transparent" href="#">
            ...
            <li class="mr-1">
            <a class="rounded-full py-2 px-3 h-8 mt-1 pt-1 inline-block text-gray-700 bg-transparent hover:bg-blue-600 hover:text-white focus:border-blue-300 ">
                3
              </a>
            </li>
            <li class="mr-1">
            ...
            <li class="mr-1">
            <a class="rounded-full py-2 px-3 h-8 mt-1 pt-1 inline-block bg-blue-600 text-white bg-transparent hover:bg-blue-600 hover:text-white focus:border-blue-300 ">
                5
              </a>
            </li>
            <li class="mr-1">
