<template>
    <div class="bg-white px-4 py-3 flex items-center justify-center border-t border-gray-200 sm:px-6">
        <div class="hidden sm:flex-1 sm:flex sm:items-center ">
            <div class="ml-2 flex">
                <p class="mt-2 text-sm leading-5 font-semibold text-gray-700">
                    Showing
                    <span >1</span>
                    to
                    <span >10</span>
      ...
      <span class="relative inline-flex ">
        <ul class="flex">
          <li class=" mr-1">
            <a class="rounded mt-1 py-1 px-2 inline-block bg-blue-100 text-blue-600 bg-transparent hover:bg-blue-600 hover:text-white focus:border-blue-300 ">
