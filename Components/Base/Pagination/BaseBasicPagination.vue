<template>
    <div class="bg-white px-4 py-3 flex items-center justify-center border-t border-gray-200 sm:px-6">
      ...
      <span class="relative inline-flex ">
        <ul class="flex">
          <li class=" mr-1">
            <a class="rounded mt-1 py-1 px-2 inline-block bg-blue-100 text-blue-600 bg-transparent hover:text-indigo-700 focus:border-blue-300 ">
          ...
          <li class=" mr-1">
            ...
            <li class="mr-1">
            <a class="rounded py-2 px-3 inline-block text-gray-700 bg-transparent hover:text-indigo-700 focus:border-blue-300 ">
                1
              </a>
            </li>
            <li class="mr-1">
            ...
            <li class="mr-1">
            <a class="rounded mt-1 py-1 px-2 inline-block text-gray-700 bg-transparent hover:text-indigo-700" href="#">
