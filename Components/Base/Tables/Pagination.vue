<template>
    ...
    <div class="flex items-center py-6">
        <span class="relative inline-flex ml-10">
            <ul class="flex">
                    <li class="mr-1">
                        <a @click.prevent="callPage(1)" class="rounded mt-1 py-1 px-2 inline-block bg-blue-100 text-blue-600 bg-transparent hover:bg-blue-500 hover:text-white focus:border-blue-300 transition ease-in-out duration-150" href="#">
                    ...
                    <li class=" mr-1">
                        <a @click.prevent="callPage(prevPage)" class="rounded mt-1 py-1 px-2 inline-block bg-blue-100 text-blue-600 bg-transparent hover:bg-blue-500 hover:text-white focus:border-blue-300 transition ease-in-out duration-150" href="#">
                    ...
                    <li v-if="currentPage !== 1 && nextPage !== 1 && currentPage !== 2" class="mr-1">
                        <a  @click.prevent="goToPage(1)" class="rounded py-2 px-3 h-8 mt-1 pt-1 inline-block text-gray-700 bg-transparent hover:bg-blue-500 hover:text-white focus:border-blue-300 transition ease-in-out duration-150" href="#">
                            1
                        </a>
                    </li>
                    ...
                    <li v-if="prevPage" class="mr-1">
                        <a @click.prevent="goToPage(prevPage)" class="rounded py-2 px-3 h-8 mt-1 pt-1 inline-block text-gray-700 bg-transparent hover:bg-blue-500 hover:text-white focus:border-blue-300 transition ease-in-out duration-150" href="#">
                           {{ prevPage }}
                        </a>
                    </li>
                    <li class="mr-1">
                    ...
                    <li v-if="nextPage" class="mr-1">
                        <a @click.prevent="goToPage(nextPage)" class="rounded py-2 px-3 h-8 mt-1 pt-1 inline-block text-gray-700 bg-transparent hover:bg-blue-500 hover:text-white focus:border-blue-300 transition ease-in-out duration-150" href="#">
                           {{ nextPage }}
                        </a>
                    </li>
                    ...
                    <li v-if="currentPage !== lastPage && nextPage !== lastPage" class="mr-1">
                        <a @click.prevent="goToPage(lastPage)" class="rounded py-2 px-3 h-8 mt-1 pt-1 inline-block text-gray-700 bg-transparent hover:bg-blue-500 hover:text-white focus:border-blue-300 transition ease-in-out duration-150" href="#">
                           {{ lastPage }}
                        </a>
                    </li>
                    <li class="mr-1">
                        <a @click.prevent="callPage(nextPage)" class="rounded mt-1 py-1 px-2 inline-block bg-blue-100 text-blue-600 bg-transparent hover:bg-blue-500 hover:text-white focus:border-blue-300 transition ease-in-out duration-150" href="#">
                            <svg class="inline-block pb-1 w-5 h-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    ...
                    <li class="mr-1">
                        <a @click.prevent="callPage(meta.last_page)" class="rounded mt-1 py-1 px-2 inline-block bg-blue-100 text-blue-600 bg-transparent hover:bg-blue-500 hover:text-white focus:border-blue-300 transition ease-in-out duration-150" href="#">
...
<!--            <input class="rounded w-20 h-8 pl-3 border border-blue-200 text-xs" v-model="page_no" type="text" placeholder="Page No." >-->
<!--            <button class=" py-1 h-8 w-20 text-xs rounded shadow bg-blue-500 hover:bg-blue-600 text-white" @click.prevent="goToPage(page_no)">Go To Page</button>-->
<!--        </div>-->
    </div>
