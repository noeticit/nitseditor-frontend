<template>
    <div class="flex">
        <ul class=" flex border-b">
            <li class="-mb-px mr-1">
                <a class="bg-white inline-block focus:border-gray-500 border-t focus:border-shadow border-r rounded-t py-2 px-4 text-blue-dark font-semibold" href="#">
            ...
            <li class="mr-1">
                <a class="bg-white inline-block py-2 px-4 text-blue hover:text-blue-darker font-semibold" href="#">
                    <svg class="inline-block w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
