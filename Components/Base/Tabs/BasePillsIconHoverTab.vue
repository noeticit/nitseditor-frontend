<template>
    <div>
        <ul class="flex">
            <li class="mr-3 mt-4">
                <a class="rounded py-3 px-3 focus:bg-blue-600 focus:text-white bg-transparent hover:bg-blue-500 hover:text-white text-gray-800" href="#">
