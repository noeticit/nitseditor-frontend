            ...
            <nits-grid :cols="per_row" :gap="2" :padding="12">
                <div v-for="(item,index) in tableData" class="m-2 mt-3 border rounded-lg shadow-lg items-center overflow-hidden">
                    ...
                    <div class="p-4">
                        ...
                        <div class="mt-3 w-full text-left text-gray-600 text-base font-normal font-sans tracking-normal leading-snug antialiased" v-html="item.description.substring(0, 150) + (item.description.length > 150 ? '': '')"></div>
                        <div class="flex mt-5">
