<template>
    <div class="">
        ...
        <div v-if="selectColumn" class="w-full flex md:px-16 md:mt-32 justify-center md:py-16 bg-gray-100">
        ...
        <div v-if="widget" class="w-full flex md:px-16 justify-center md:mt-32 md:py-16 bg-gray-100">
