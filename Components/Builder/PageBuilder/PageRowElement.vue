<template>
    <div class="">
        ...
        <div v-if="selectColumn" class="w-full flex justify-center md:py-32 mt-2 md:mt-10 bg-gray-100">
            <div class="border w-1/2 flex flex-col border-dashed border-indigo-700 md:py-4">
        ...
        <div v-if="widget" class="w-full flex justify-center md:py-32 mt-2 md:mt-10 bg-gray-100">
